                                                ...
                                                <tbody>
                                                    <?php foreach ($siteAdmin->ARRAY_ARTIGOSINFO as $item): ?>
                                                        <tr>
                                                            ...
                                                            <td class="align-middle"><a href="https://parquedashortensias.codemaze.com.br/pages/instrucoesAdequacoes/insertPendencia.php?id=<?php echo $item['EPE_IDEVOLUCAO_PENDENCIA']; ?>" class="text-success"><i class="fas fa-edit"></i></a></td>       
    ...
    <script>
        $(document).ready(function () {
            $('#basic-datatable').DataTable({
                ...
                order: [[6, 'asc']], // Ordena pela coluna "DATA" (índice 6)
                language: {
...
function confirmDelete(event, id) {
    ...
    Swal.fire({
        title: 'Formulário de Pendências',
        text: "Tem certeza que deseja exluir o pendência?",
        showDenyButton: true,
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "deletePendenciaProc.php", // URL para processamento
                type: "POST",
