                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="col-sm-5">
                                            <a href="insertPendencia.php" class="btn btn-danger mb-2" style="background-color: #aa2ed8; color: black;"><i class="mdi mdi-plus-circle me-2"></i> Adicionar Pendência</a>
                                        </div>
