                                        ...
                                        <div class="tab-pane show active" id="basic-datatable-preview">
                                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                    <tr>    
                                                        <td class="align-middle" style="font-size: 12px; word-wrap: break-word;"><?= htmlspecialchars($item['PDS_DCNOME_PRESTADOR']); ?></td>
                                                        <td class="align-middle" style="font-size: 12px;"><?= htmlspecialchars($item['PDS_DCCAMPANHA']); ?></td>
