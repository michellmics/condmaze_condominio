                ...
                <div class="container-fluid"><!-- INICIO CONTEUDO CONTAINER -->
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">                                    
                                    <h4 class="header-title" id="toggleAcademia" style="display: flex; align-items: center; cursor: pointer;"><i class="ri-heart-pulse-line ri-2x" style="color:rgb(218, 5, 200); margin-right: 8px;"></i>Academias</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title" id="toggleFastfood" style="display: flex; align-items: center; cursor: pointer;"><i class="ri-takeaway-line ri-2x" style="color:rgb(218, 5, 200); margin-right: 8px;"></i>Fast Food</h4>
                                    <p class="text-muted font-14 mb-3"></p>
                                    <div class="tab-content">
                                    <div class="col-sm-5"  style="margin-bottom: 20px;">
                                    </div>
