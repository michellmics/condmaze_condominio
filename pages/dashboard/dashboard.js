(function(r) {
    ...
    e.prototype.initCharts = function() {
        ...
        var o = {
            ...
            xaxis: {
                categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],  // Meses do ano
                axisBorder: {
                    show: false  // Desativa a borda do eixo X
                }
            },
            yaxis: {
                ...
                labels: {
                    formatter: function(e) {
                        return e + "k";  // Formatação dos rótulos do eixo Y (ex: "40k")
                    },
                    offsetX: -15
                }
            },
            ...
            tooltip: {
                y: {
                    formatter: function(e) {
                        return "$" + e + "k";  // Formatação das tooltips
                    }
                }
            }
        };
        new ApexCharts(document.querySelector("#codemaze_bar_chart"), o).render();  // Renderiza o gráfico de barras
