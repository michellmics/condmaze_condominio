...
<div class="modal fade" id="imagemModal" tabindex="-1" aria-labelledby="imagemModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="imagemModalLabel">CLOSE NO PET :)</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                                                ...
                                                <tbody>
                                                    <?php foreach ($siteAdmin->ARRAY_PETSINFO as $item): ?>
                                                        <tr> 
                                                            ...
                                                            <td style="vertical-align: middle;"> <i class="<?php echo $iconPet; ?>" style="color:rgb(2, 133, 255); font-size: 18px;"></i> </td>                                                
                                                            <td style="cursor: pointer; font-size: 10px; vertical-align: middle;"><?= htmlspecialchars(substr(strtoupper($item['PEM_DCNOME']),0,13)); ?></td>
                                                            <td style="cursor: pointer; font-size: 10px; vertical-align: middle;"><?= htmlspecialchars(substr(strtoupper($item['PEM_DCRACA']),0,13)); ?></td>                                                        
