                                ...
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" id="form" name="form" role="form" method="POST" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <button class="btn col-lg-1" style="background-color: #aa2ed8; color: white;" onclick="window.history.back()" type="button">Voltar</button>
                                            <?php if ($nivelAcesso == 'SINDICO' || $nivelAcesso == 'SUPORTE'): ?>              
                                            <button class="btn col-lg-1" style="background-color: #20fead; color: black;" type="button" id="botao" name="botao">Salvar</button>   
                                            <?php endif; ?>                                       
