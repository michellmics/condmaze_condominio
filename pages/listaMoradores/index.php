                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="col-sm-5">
                                            <a href="insertMorador.php" class="btn btn-danger mb-2" style="background-color: #aa2ed8; color: black;"><i class="mdi mdi-plus-circle me-2"></i> Adicionar Morador</a>
                                        </div>
                                        <?php endif; ?> 
                                        <br>
                                            ...
                                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                <tbody>
                                                    <?php foreach ($siteAdmin->ARRAY_LISTAMORADORESINFO as $item): ?>
                                                        ...
                                                        <?php endif; ?>      
                                                        <?php if ($nivelAcesso != 'SINDICO'): ?>
                                                        <td class="align-middle" style="cursor: pointer;" ><i class="ri-list-unordered" style="color:rgb(170, 5, 129); font-size: 18px;"></i></td>   
                                                        <?php endif; ?>                                                
