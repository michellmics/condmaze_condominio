  ...
  session_start();
    ...
    $metodo = "insert";
        ...
        if(isset($_GET['apartamento']))
        {
          ...
          $readonly = "readonly style='background-color: #c8cacc;'";
                                        ...
                                        <div class="tab-pane show active" id="tooltips-validation-preview">
                                            <form class="needs-validation" id="form" name="form" role="form" method="POST" enctype="multipart/form-data" novalidate>
                                                ...
                                                <div class="position-relative mb-3">
                                                    ...
                                                    <input value="<?php if(isset($telefone)){echo $telefone;} ?>" id="telefone" name="telefone" type="text" class="form-control" placeholder="Ex.: 11982734359" pattern="^\d{11}$"  minlength="11" maxlength="11" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required />
                                                    <div class="valid-tooltip">
                                                        Validado!
                                                    </div>
                                                    <div class="invalid-tooltip">
