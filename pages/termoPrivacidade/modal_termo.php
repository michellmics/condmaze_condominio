...
<body>
    ...
    <div class="modal fade show d-block" id="modalTermo" tabindex="-1" aria-labelledby="modalTermoLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btnAceitar" class="btn btn-success" disabled data-bs-dismiss="modal">OK</button>
                </div>
            </div>
        </div>
    </div>
