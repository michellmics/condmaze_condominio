                                            ...
                                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                <?php foreach ($siteAdmin->ARRAY_ENCOMENDAINFO as $index => $item): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle" nome="<?= htmlspecialchars($item['USU_DCNOME']); ?>" style="font-size: 12px; word-wrap: break-word; white-space: normal;"><?= htmlspecialchars($item['USU_DCNOME']); ?></td>
