                                            ...
                                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                <?php foreach ($siteAdmin->ARRAY_ENCOMENDAINFO as $index => $item): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle" nome="<?= htmlspecialchars($item['USU_DCNOME']); ?>" style="font-size: 12px; word-break: break-word; white-space: normal; max-width: 100px; overflow-wrap: break-word; hyphens: auto; "><?= htmlspecialchars($item['USU_DCNOME']); ?></td>
