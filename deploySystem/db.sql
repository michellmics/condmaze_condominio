...
('EMAIL_ALERTAS', 'SINDICO@CONDOMINIO.COM.BR', 'E-MAIL ONDE SÃO ENVIADOS OS ALERTAS DO SISTEMA.'),
...
INSERT INTO `USU_USUARIO` (`USU_IDUSUARIO`, `USU_DCNOME`, `USU_DCAPARTAMENTO`, `USU_DCBLOCO`, `USU_DCNIVEL`, `USU_DTCADASTRO`, `USU_DCSENHA`, `USU_DCEMAIL`, `USU_DCREDEF_TOKEN`, `USU_DTREDEF_TOKEN_EXP`) VALUES
(100, 'CODEMAZE', 9999, 1, 'SINDICO', '2024-12-23 06:52:48', '$2y$10$p9CXSmR3ZWDn53hzo62WK.Ncc5C8bXpKH2gV.PSs.ND6mviJGyDWm', 'SUPORTE@CODEMAZE.COM.BR', '10ea0fe85435465bab5e4cceefff56b8', '2025-01-02 12:53:42')
