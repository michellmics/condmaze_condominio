                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-dashboards" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="uil-window"></i>Início <div class="arrow-down"></div>
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-components">
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-apexcharts" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Apex Charts <div class="arrow-down"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-apexcharts">
                                            ...
                                            <a href="charts-apex-timeline.html" class="dropdown-item">Timeline</a>
                                            <a href="charts-apex-boxplot.html" class="dropdown-item">Boxplot</a>
                                            <a href="charts-apex-treemap.html" class="dropdown-item">Treemap</a>
                                            ...
                                            <a href="charts-apex-polar-area.html" class="dropdown-item">Polar Area</a>
                                            <a href="charts-apex-sparklines.html" class="dropdown-item">Sparklines</a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-other-charts" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Charts <div class="arrow-down"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-other-charts">
                                            <a href="charts-chartjs-area.html" class="dropdown-item">Chartjs</a>
