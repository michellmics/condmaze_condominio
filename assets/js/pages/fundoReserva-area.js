var colors = ["#fa6767"],
    ...
    options = ((dataColors = $("#area-chart-github").data("colors")) && (colors = dataColors.split(",")), {
        chart: {
            height: 175,
            type: "area",
            toolbar: {
    ...
    options = ((dataColors = $("#stacked-area").data("colors")) && (colors = dataColors.split(",")), {
        series: [{
            name: "South",
...
colors = ["#39afd1", "#fa5c7c", "#727cf5"], (dataColors = $("#area-timeSeries").data("colors")) && (colors = dataColors.split(",")), options = {
    series: [{
        name: "PRODUCT A",
        data: dataSet[0]
    }, {
...
}, (chart = new ApexCharts(document.querySelector("#area-timeSeries"), options)).render(), colors = ["#6c757d"], dataColors = $("#area-chart-nullvalues").data("colors"), options = {
    series: [{
        name: "Network",
        data: [{
            x: "Dec 23 2017",
